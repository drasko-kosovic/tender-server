...
public class PonudeServiceImpl implements PonudeService {
    ...
    @Override
    public List<Ponude> findBrojTenderaPonudac(String broj_tendera, String ponudjac) {
        return ponudeRepository.findByBrojTenderaPonudjac(broj_tendera,ponudjac);
    }

    @Override
    public List<Ponude> PrekoProcijenjeneByBrojTendera(String brojTendera) {
    ...
    @Override
    public Optional<Ponude> findById(Integer id) {
...
//	}
    ...
    @Override
    public List<Ponude> PrekoProcijenjene() {
        List<Ponude> ponude = ponudeRepository.PrekoProcijenjene();
        return ponude;
    }
    ...
    @Override
    public List<Ponude> findNemaPonudaByBrojTendera(String brojTendera) {
        return ponudeRepository.findNema_ponudaByBrojTendera(brojTendera);
    }


    @Override
    public List<Ponude> findByCriteria(String criteria, String searchItem) {

        switch (criteria) {

            case "ponudjac":
                return this.ponudeRepository.findByPonudjac(searchItem);
//			case "broj_tendera":
//				return this.tenderRepository.findByBrojTendera(searchBrojTendera);
